...
This page summarizes what the **2026-06-24 proof run** established, how it relates to the [NLS five-phase pipeline](../../../docs/NLS_PIPELINE.md), and what remains open.
...
## Context: full pipeline vs v0.1 OSS

The [NLS five-phase pipeline](../../../docs/NLS_PIPELINE.md) describes:
...
See [RoPE geometry](07_rope_geometry.md).
...
Canonical postfix artifacts supersede any pre-fix triage notes.
