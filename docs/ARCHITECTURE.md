...
**Full NLS design (five phases, retrieval, scoring, hot-swap):** [NLS_PIPELINE.md](NLS_PIPELINE.md)  
**Documentation map:** [PLATFORM.md](PLATFORM.md)
...
| [NLS phase](NLS_PIPELINE.md) | PRI module | v0.1 OSS |
|-----|-----|-----|
...
| Monitoring (hot-swap) | — | Production plugin only |
